...
{
    public class OrganizacionHelper : BaseHelper
    {
        ...
        public void AgregarOrganizacion()
        {
            ...
            {
                MostrarError($"Error al agregar organización: {ex.Message}");
            }
        }

        public void EditarOrganizacion(int id)
        {
            var context = new DonactivaRD_DataContext();
            ...
            {
                MostrarError($"Error al editar organización: {ex.Message}");
            }
        }
        ...
        public void BuscarOrganizacion(string criterio)
        {
            var context = new DonactivaRD_DataContext();
        ...
        public void EliminarOrganizacion(int id)
        {
            ...
            {
                MostrarError($"Error al eliminar organización: {ex.Message}");
            }
        }
    }
}
